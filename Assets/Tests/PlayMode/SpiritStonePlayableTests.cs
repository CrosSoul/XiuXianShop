...
namespace XiuXianShop.Tests
{
    ...
    {
        [UnityTest,Category("DP33"),Category("DP27")] public IEnumerator ResourceChangesRefreshVisibleValueAndKeepDraggedInstance()
        {
            ...
            yield return Drag(mid,ContainerId.Display,0,0);Assert.That(s.PreviewAttraction().BuyingCategories.Single(c=>c.Category==ItemCategory.StoneMid).DisplayedCount,Is.EqualTo(1));
            yield return CloseBusinessForOuting();yield return Click("CarryOpen");yield return Click("CarryConfirm");
